...
Revises: 
Create Date: 2022-01-19 12:19:29.113484
...
def upgrade():
    ...
    sa.Column('amount', sa.DECIMAL(precision=64, scale=0), nullable=True),
    ...
    sa.Column('min_value', sa.DECIMAL(precision=64, scale=0), nullable=True),
    sa.Column('max_value', sa.DECIMAL(precision=64, scale=0), nullable=True),
