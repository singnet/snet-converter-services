...
class TokenFactory:
    ...
    @staticmethod
    def token_pair(id, min_value, max_value, contract_address, created_by, created_at, updated_at, from_token,
        ...
        return TokenPair(id=id, min_value=min_value, max_value=max_value, contract_address=contract_address,
